...
describe('EscPosEncoder', function() {
  const encoder: EscPosEncoder = new EscPosEncoder();

  describe('text(hello)', function() {
    const result: Uint8Array = encoder.text('hello').encode();
  ...
  describe('text(hello).newline()', function() {
    const result: Uint8Array = encoder.text('hello').newline().encode();
  ...
  describe('line(hello)', function() {
    const result: Uint8Array = encoder.line('hello').encode();
  ...
  describe('text(héllo) - é -> ?', function() {
    const result: Uint8Array = encoder.text('héllo').encode();
  ...
  describe('codepage(cp437).text(héllo) - é -> 130', function() {
    const result: Uint8Array = encoder.codepage('cp437').text('héllo').encode();
  ...
  describe('codepage(cp936).text(简体中文) - simplified chinese', function() {
    const result: Uint8Array = encoder.codepage('cp936').text('简体中文').encode();
  ...
  describe('codepage(win1252).text(héllo) - é -> 233', function() {
    const result: Uint8Array = encoder.codepage('windows1252').text('héllo').encode();
  ...
  describe('codepage(utf8).text(héllo)', function() {
    it('should throw an "Codepage not supported by printer" error', function() {
      expect(function() {
        encoder.codepage('utf8' as any).text('héllo').encode();
  ...
  describe('codepage(unknown).text(héllo)', function() {
    it('should throw an "Unknown codepage" error', function() {
      expect(function() {
        encoder.codepage('unknown' as any).text('héllo').encode();
      }).to.throw('Unknown codepage');
    });
  });

  describe('bold(true).text(hello).bold(false)', function() {
    const result: Uint8Array = encoder.bold(true).text('hello').bold(false).encode();
  ...
  describe('bold().text(hello).bold()', function() {
    const result: Uint8Array = encoder.bold().text('hello').bold().encode();
  ...
  describe('italic().text(hello).italic()', function() {
    const result: Uint8Array = encoder.italic().text('hello').italic().encode();
  ...
  describe('underline(true).text(hello).underline(false)', function() {
    const result: Uint8Array = encoder.underline(true).text('hello').underline(false).encode();
  ...
  describe('underline().text(hello).underline()', function() {
    const result: Uint8Array = encoder.underline().text('hello').underline().encode();
  ...
  describe('align(left).line(hello)', function() {
    const result: Uint8Array = encoder.align('left').line('hello').encode();
  ...
  describe('align(center).line(hello)', function() {
    const result: Uint8Array = encoder.align('center').line('hello').encode();
  ...
  describe('align(right).line(hello)', function() {
    const result: Uint8Array = encoder.align('right').line('hello').encode();
  ...
  describe('qrcode(https://nielsleenheer.com)', function() {
    const result: Uint8Array = encoder.qrcode('https://nielsleenheer.com').encode();
  ...
  describe('qrcode(https://nielsleenheer.com, 1, 8, h)', function() {
    const result: Uint8Array = encoder.qrcode('https://nielsleenheer.com', 1, 8, 'h').encode();
  ...
  describe('barcode(3130630574613, ean13, 60)', function() {
    const result: Uint8Array = encoder.barcode('3130630574613', 'ean13', 60).encode();
  ...
  describe('barcode(CODE128, code128, 60)', function() {
    const result: Uint8Array = encoder.barcode('CODE128', 'code128', 60).encode();
  ...
  describe('barcode({ACODE128, code128, 60)', function() {
    const result: Uint8Array = encoder.barcode('{ACODE128', 'code128', 60).encode();
  ...
  describe('barcode({BCODE128, code128, 60)', function() {
    const result: Uint8Array = encoder.barcode('{BCODE128', 'code128', 60).encode();
  ...
  describe('barcode({C2Uc#, code128, 60)', function() {
    const result: Uint8Array = encoder.barcode('{C2Uc#', 'code128', 60).encode();
  ...
  describe('image(canvas, 8, 8) - with a black pixel at 0,0', function() {
    ...
    const result: Uint8Array = encoder.image(canvas, 8, 8).encode();
  ...
  describe('cut()', function() {
    const result: Uint8Array = encoder.cut().encode();

    it('should be [ 29, 86, 0 ]', function() {
      assert.deepEqual(new Uint8Array([29, 86, 0]), result);
    });
  });

  describe('cut(full)', function() {
    const result: Uint8Array = encoder.cut('full').encode();
  ...
  describe('cut(partial)', function() {
    const result: Uint8Array = encoder.cut('partial').encode();

    it('should be [ 29, 86, 1 ]', function() {
      assert.deepEqual(new Uint8Array([29, 86, 1]), result);
    });
  });

  describe('raw([ 0x1c, 0x2e ])', function() {
    const result: Uint8Array = encoder.raw([0x1c, 0x2e]).encode();

...
describe('EscPosEncoder', function() {
    ...
    describe('text(hello)', function () {
        let result: Uint8Array = encoder.text('hello').encode();
    ...
    describe('text(hello).newline()', function () {
        let result: Uint8Array = encoder.text('hello').newline().encode();
    ...
    describe('line(hello)', function () {
        let result: Uint8Array = encoder.line('hello').encode();
    ...
    describe('text(héllo) - é -> ?', function () {
        let result: Uint8Array = encoder.text('héllo').encode();
    ...
    describe('codepage(cp437).text(héllo) - é -> 130', function () {
        let result: Uint8Array = encoder.codepage('cp437').text('héllo').encode();
    ...
    describe('codepage(cp936).text(简体中文) - simplified chinese', function () {
        let result: Uint8Array = encoder.codepage('cp936').text('简体中文').encode();
    ...
    describe('codepage(win1252).text(héllo) - é -> 233', function () {
        let result: Uint8Array = encoder.codepage('windows1252').text('héllo').encode();
    ...
    describe('codepage(utf8).text(héllo)', function () {
        it('should throw an "Codepage not supported by printer" error', function () {
            expect(function(){
                let result: Uint8Array = encoder.codepage('utf8' as any).text('héllo').encode();
    ...
    describe('codepage(unknown).text(héllo)', function () {
        it('should throw an "Unknown codepage" error', function () {
            expect(function(){
                let result: Uint8Array = encoder.codepage('unknown' as any).text('héllo').encode();
            }).to.throw('Unknown codepage');
        });
    });

    describe('bold(true).text(hello).bold(false)', function () {
        let result: Uint8Array = encoder.bold(true).text('hello').bold(false).encode();
    ...
    describe('bold().text(hello).bold()', function () {
        let result: Uint8Array = encoder.bold().text('hello').bold().encode();
    ...
    describe('italic().text(hello).italic()', function () {
        let result: Uint8Array = encoder.italic().text('hello').italic().encode();
    ...
    describe('underline(true).text(hello).underline(false)', function () {
        let result: Uint8Array = encoder.underline(true).text('hello').underline(false).encode();
    ...
    describe('underline().text(hello).underline()', function () {
        let result: Uint8Array = encoder.underline().text('hello').underline().encode();
    ...
    describe('align(left).line(hello)', function () {
        let result: Uint8Array = encoder.align('left').line('hello').encode();
    ...
    describe('align(center).line(hello)', function () {
        let result: Uint8Array = encoder.align('center').line('hello').encode();
    ...
    describe('align(right).line(hello)', function () {
        let result: Uint8Array = encoder.align('right').line('hello').encode();
    ...
    describe('qrcode(https://nielsleenheer.com)', function () {
        let result: Uint8Array = encoder.qrcode('https://nielsleenheer.com').encode();
    ...
    describe('qrcode(https://nielsleenheer.com, 1, 8, h)', function () {
        let result: Uint8Array = encoder.qrcode('https://nielsleenheer.com', 1, 8, 'h').encode();
    ...
    describe('barcode(3130630574613, ean13, 60)', function () {
        let result: Uint8Array = encoder.barcode('3130630574613', 'ean13', 60).encode();
    ...
    describe('barcode(CODE128, code128, 60)', function () {
        let result: Uint8Array = encoder.barcode('CODE128', 'code128', 60).encode();
    ...
    describe('barcode({ACODE128, code128, 60)', function () {
        let result: Uint8Array = encoder.barcode('{ACODE128', 'code128', 60).encode();
    ...
    describe('barcode({BCODE128, code128, 60)', function () {
        let result: Uint8Array = encoder.barcode('{BCODE128', 'code128', 60).encode();
    ...
    describe('barcode({C2Uc#, code128, 60)', function () {
        let result: Uint8Array = encoder.barcode('{C2Uc#', 'code128', 60).encode();
    ...
    describe('image(canvas, 8, 8) - with a black pixel at 0,0', function () {
        ...
        let result: Uint8Array = encoder.image(canvas, 8, 8).encode();
    ...
    describe('cut()', function () {
        let result: Uint8Array = encoder.cut().encode();
    ...
    describe('cut(full)', function () {
        let result: Uint8Array = encoder.cut('full').encode();
    ...
    describe('cut(partial)', function () {
        let result: Uint8Array = encoder.cut('partial').encode();
    ...
    describe('raw([ 0x1c, 0x2e ])', function () {
        let result: Uint8Array = encoder.raw([ 0x1c, 0x2e ]).encode();

...
var EscPosEncoder = /** @class */ (function () {
     ...
     * @return Return the object, for easy chaining commands
     */
    EscPosEncoder.prototype.size = function (e) {
        var font = 0; // default: Font A
        var scale = 0x00; // default: normal size
        switch (e) {
            case 'small':
                font = 1; // Font B
                break;
    ...
    EscPosEncoder.prototype.image = function (element, width, height, algorithm, threshold) {
        ...
        var getPixel = function (x, y) { var _a, _b; return ((_b = (_a = image.data) === null || _a === void 0 ? void 0 : _a[((width * y) + x) * 4]) !== null && _b !== void 0 ? _b : 0) > 0 ? 0 : 1; };
